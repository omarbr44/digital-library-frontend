<template>
    <div>
        <div style="z-index: 1051;" v-if="msgQuery" class="alert alert-success d-flex align-items-center alert-dismissible fade show" role="alert">
...
const deletee = async (id)=>{
                const { awaitdata,awaiterror } = await useDelete('api/Category/destroy/'+id)

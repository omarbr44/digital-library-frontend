<template>
  ...
  <div>
    {{ msgQuery }}
        ...
        <Hero :obj="{
            el1 : 'تصفح البرامج ',
            el2 : 'تصفح البرامج الموجودة مع خاصية البحث وايضا الفلترة بالفئات مع امكانية تحميل البرامج',
            el3 : 'addprogram',
            el4 : 'اضافة برنامج'
        }" />
        <nav  style="--bs-breadcrumb-divider: '<';
         background-color: #f7f7f7;" aria-label="breadcrumb">
             <ol class="breadcrumb justify-content-end mx-4 my-3 p-3">
                <li class="breadcrumb-item active">تصفح البرامج</li>
         ...
         <section class="cards">
            <div class="container px-4 px-md-3" >
                <div class="row my-5" >
                   <AsyncShowPrograms @paginationEmit="pagination" :filterValue="filterValue" 
...
import AsyncShowPrograms from '../../components/Async/AsyncShowPrograms.vue';

       ...
       <div class="row align-items-lg-center">
         ...
         <div class="col-md-8 order-md-2 col-lg-6 text-center text-md-end" data-aos="zoom-in" data-aos-delay="250">
           ...
           <div class="d-flex flex-column flex-md-row justify-content-end text-white">
             <a href="#" class="btn btn-lg btn-bd-primary mb-3 me-md-3 br-green" >تسجيل الدخول </a>
             <a href="#" class="btn btn-lg mb-3 bk-green text-white" >تصفح</a>
           </div>
       ...
       <div class="row align-items-lg-center">
         ...
         <div class="col-md-8 order-md-2 col-lg-7 text-center text-md-end text-white"  data-aos="fade-right" data-aos-delay="200">
           ...
           <div class="d-flex flex-column flex-md-row justify-content-end">
             <a href="#" class="bk-green btn btn-lg  mb-3 text-white " >
     ...
     <div class="container px-4 px-md-3" data-aos="fade-up">
       <div class="row row_ser2 align-items-lg-center " data-aos="zoom-in" data-aos-delay="200">
         ...
         <div class="col-md-8 order-md-1 col-lg-7 text-center text-md-end " >
           ...
           <div class="d-flex flex-column flex-md-row justify-content-end text-white">
             <a href="#" class="bk-green btn btn-lg text-white  mb-3 br-green" >تصفح </a>
           </div>
       ...
       <div class="row row_ser2 align-items-lg-center" data-aos="zoom-in" data-aos-delay="200">
         ...
         <div class="col-md-8 order-md-1 col-lg-7 text-center text-md-end " >
           ...
           <div class="d-flex flex-column flex-md-row justify-content-end text-white">
             <a href="#" class="bk-green btn btn-lg  mb-3 text-white br-green" >تصفح </a>
           </div>
           
         </div>
       </div>
 
       <div class="row align-items-lg-center my-5 top-border" >
...
امكانية رفع اي وسائط تعليمية سواء كانت كتب , دورات ، برامج ، كتب صوتية</p>
           <div class=" text-white text-center my-5">
             <a href="#"  class="bk-green btn btn-lg fs-2 text-white rounded-pill br-green clamp-padding" > 
   ...
   <section class="slider">
    <div  class="container">
    <h1 class="h1 text-end m-3 display-1 text-white">جديد الكتب</h1>
